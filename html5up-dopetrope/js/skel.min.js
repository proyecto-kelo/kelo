...
var skel=function(){
	var e="config",t="breakpoints",n="iterate",r="stateId",i="getElementsByClassName";
	var s="elements",o="stateElements",u="getElementsByTagName",a=!1,f="length";
	var l=" 0 0 ",c=null,h="getCachedElement",p="viewport",d="cacheNewElement";
	var v="config_breakpoint",m="gutters",g="vars",y="insertBefore",b="newInline";
	var w=!0,E="}",S="parentNode",x="orientationChange",T="locations",N="createElement";
	var C="deviceType",k="substring",L="object",A="className",O="isArray",M="match";
	var _="cache",D="+*,",P="replace",H="head",B="newElement",j="indexOf";
	var F="_skel_isReversed",I="push",q="extend",R="grid",U="matchesMedia";
	var z="containers",W="maxGridZoom",X="onorientationchange",V="defaults",$="lock";
	var J="DOMReady",K="getComputedStyle",Q="addEventListener",G="^head";
	var Y="{display:none!important}",Z="parseMeasurement",et="registerLocation";
	var tt="placeholder",nt="events",rt="IEVersion",it="documentElement";
	var st="attachElements",ot="plugins",ut="attachElement",at="location";
	var ft="DOMContentLoaded",lt="text/css",ct="initial-scale=1",ht="device-width";
	var pt="states",dt="_skel_attach",vt="removeEventListener",mt="previousSibling";
	var gt="collapse",yt="change",bt="attached",wt="normalize",Et="applyRowTransforms";
	var St="media",xt="(min-width: ",Tt="resize",Nt="split",Ct="_skel_placeholder";
	var kt="firstChild",Lt="html",At="forceDefaultState",Ot="querySelectorAll";
	var Mt="max-height",_t="min-height",Dt="innerHTML",Pt="prototype",Ht="max-width";
	var Bt="min-width",jt="nextSibling",Ft="domready",It="hasOwnProperty";
	var qt="readyState",Rt="onresize",Ut="android",zt="zoom",Wt="priority";
	var Xt="isStatic",Vt="href",$t=".\\3$1 ",Jt="height=";
	var Kt={
		breakpoints:[],
		breakpointList:[],
		cache:{
	...
	extend:function(e,t){
		var r;
		Kt[n](t,function(n){
			Kt[O](t[n])?(Kt[O](e[n])||(e[n]=[]),Kt[q](e[n],t[n])):typeof t[n]==L?(typeof e[n]!=L&&(e[n]={}),Kt[q](e[n],t[n])):e[n]=t[n]}
			)
	},
	getArray:function(e){
		return Kt[O](e)?e:[e]},
